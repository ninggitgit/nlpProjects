...
import pandas as pd
train_df = pd.read_csv('../nlpfirst/files/train_set.csv', sep='\t')
...
print(train_df['label'].values[:10000])
...
train_df = pd.read_csv('../nlpfirst/files/train_set.csv', sep='\t', nrows=15000)
...
model = FastText('train.csv',window=2, 
...
fold_num = 10
data_file = '../nlpfirst/files/train_set.csv'
import pandas as pd
...
# test
test_data_file = '../nlpfirst/files/test_a.csv'
...
# build word encoder
word2vec_path = '../nlpfirst/files/word2vec.txt'
dropout = 0.15
